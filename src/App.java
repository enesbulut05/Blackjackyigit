            ...
            while (true) {
                for (Player player : players) {
                    ...
                    if (playerDeck.getBet() > player.getBalance()) {
                        ...
                        //playerDeck.setCards(new ArrayList<>(List.of(new Card("2", 2), new Card("2", 2))));
                        player.setPlayerDeck(playerDeck);

                        player.reduceBalance(playerDeck.getBet());
                        System.out.println(player.getName() + ": Bahis miktarı: " + playerDeck.getBet() + " --- Güncel Bakiye: " + player.getBalance());
